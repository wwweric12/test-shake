...
const nextConfig: NextConfig = {
  ...
  async headers() {
    const cspHeader = [
      ...
      "connect-src 'self' https://api.hand-shake.site wss://api.hand-shake.site https://d2blv8nn6wgtte.cloudfront.net https://hand-shake-bucket.s3.ap-northeast-2.amazonaws.com https://*.kakao.com https://cdn.jsdelivr.net;",
    ].join(' ');
