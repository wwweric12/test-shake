...
import SwipingCard from '@/app/(main)/recommendation/components/SwipingCard';
import { ProfileErrorState } from '@/app/(main)/user/info/components/ProfileErrorState';
import { ProfileHeader } from '@/app/(main)/user/info/components/ProfileHeader';
