...
export default function ProfileCard({ dsti, profileImageUrl }: ProfileCardProps) {
  ...
  const detailUrl = `/dsti?type=${dsti}`;

  return (
    <div className="mb-4 flex gap-2">
      <Link
        href={detailUrl}
        className="flex min-w-[128px] flex-col items-center justify-center rounded-[10px] bg-white py-[18px] shadow-sm transition-opacity active:opacity-80"
      >
